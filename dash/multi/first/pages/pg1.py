...
# input from the drop down 
# output into the histogram figure field which is originally set to continent 
@callback(
    Output('line-fig', 'figure'),
    Input('cont-choice', 'value')
)
def update_graph(value):
    # if the value is None, default
    if value is None:
    ...
    # return the figure as this is what we're setting equal to the histogram 
    return fig